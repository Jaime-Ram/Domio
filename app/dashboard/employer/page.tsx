      ...
      <div className="flex flex-col gap-8 min-w-0">
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            <SectionLabel href="/dashboard/employer/financial/betalingen">Huurinkomsten</SectionLabel>
        ...
        {/* Recente activiteit */}
        <div>
          <SectionLabel href="/dashboard/employer/financial/betalingen">Recente activiteit</SectionLabel>
      ...
      <div className="flex flex-col gap-6">
        ...
        {!dismissed.includes('compliance') && (
          <div className="rounded-2xl bg-[#163300] px-4 py-4 relative">
            ...
            <Link href="/dashboard/employer/compliance/alerts" className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-[#9FE870] hover:text-[#9FE870]/80 transition-colors">
        ...
        {!dismissed.includes('taken') && (
          <div className="relative rounded-2xl bg-[#f4f4f4] dark:bg-neutral-800 px-4 py-4">
            ...
            <Link href="/dashboard/employer/tasks" className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-[#163300] dark:text-[#9FE870] hover:underline">
        ...
        {!dismissed.includes('financieel') && (
          <div className="relative rounded-2xl bg-[#f4f4f4] dark:bg-neutral-800 px-4 py-4">
            ...
            <Link href="/dashboard/employer/financial" className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-[#163300] dark:text-[#9FE870] hover:underline">
