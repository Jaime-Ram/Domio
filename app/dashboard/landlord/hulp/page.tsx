      ...
      <div className="grid gap-content-blocks md:grid-cols-2">
        ...
        >
          <div className="flex items-start gap-4">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#f4f4f4] dark:bg-neutral-800 text-[#1d3014] dark:text-[#c8e957]">
              <Phone className="h-6 w-6" strokeWidth={2} />
            </span>
            <div>
              <h2 className="text-xl font-semibold text-[#1d3014] dark:text-[#c8e957]">Bel ons</h2>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-semibold text-[#1d3014] dark:text-[#c8e957]">Veelgestelde vragen</h2>
              <p className="mt-1 text-sm text-[#55554e] dark:text-[#97978f]">
