...
export default function MjopBuildingPage({ params }: { params: Promise<{ buildingId: string }> }) {
  ...
  if (!building) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center px-6">
        ...
        <Link href="/dashboard/landlord/mjop" className="mt-4 text-sm text-[#163300] underline">Terug naar MJOP</Link>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col min-h-0 h-full">
      {/* Header */}
      <div className="px-6 pt-5 pb-0 border-b border-gray-200 dark:border-neutral-700 shrink-0">
        <Link
          href="/dashboard/landlord/mjop"
          className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-800 dark:hover:text-gray-300 mb-4 transition-colors"
        >
        ...
        <div className="flex items-start gap-3 mb-4">
          <div className="h-10 w-10 rounded-xl bg-[#163300]/8 dark:bg-[#9FE870]/10 flex items-center justify-center shrink-0 mt-0.5">
            <Building2 className="h-5 w-5 text-[#163300] dark:text-[#9FE870]" />
          </div>
          <div className="flex-1 min-w-0">
            <h1 className="text-xl font-semibold text-gray-900 dark:text-white leading-tight">{building.name}</h1>
            {building.address && (
              <p className="text-sm text-gray-500 dark:text-neutral-400 mt-0.5 flex items-center gap-1">
