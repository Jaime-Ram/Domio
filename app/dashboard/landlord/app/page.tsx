  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-6">
      ...
      <div className="relative mx-auto mb-8 h-28 w-28 flex items-center justify-center">
        <span
          aria-hidden
          className="absolute inset-0 rounded-[26px] bg-[#c8e957]/22 blur-[14px]"
        />
        <span
          aria-hidden
        ...
        />
        <div className="relative h-24 w-24 rounded-[22px] bg-[#c8e957] flex items-center justify-center shadow-[0_10px_22px_rgba(22,51,0,0.16),0_4px_10px_rgba(22,51,0,0.12),inset_0_1px_0_rgba(255,255,255,0.32)]">
          <img
      ...
      {/* Text */}
      <h1 className="text-3xl font-bold text-[#1d3014] dark:text-[#c8e957] mb-3">
        Domio App
      </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="h-12 px-5 rounded-xl bg-[#1d3014] dark:bg-neutral-800 flex items-center gap-3 opacity-40 cursor-not-allowed select-none">
