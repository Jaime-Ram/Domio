    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] w-full px-4">
      <div className="w-full max-w-3xl flex flex-col items-center">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-[#97978f] dark:text-[#97978f] mt-1.5">
        ...
        <div className="w-full">
          <div className="flex items-center gap-2 opacity-50 cursor-not-allowed pointer-events-none select-none">
            ...
            <div className="size-10 shrink-0 rounded-full bg-[#f4f4f1] dark:bg-neutral-800 flex items-center justify-center">
              <Paperclip className="h-4 w-4 text-[#97978f]" />
            </div>

            {/* Input field */}
            <div className="relative flex-1 min-h-[40px] rounded-3xl bg-white/85 dark:bg-neutral-900/90 backdrop-blur-md border border-[#e3e3de]/90 dark:border-neutral-600 shadow-sm">
              <Search className="absolute left-3.5 top-[13px] h-4 w-4 text-[#97978f]" />
              <div className="pl-10 pr-4 py-2.5 text-sm text-[#97978f] dark:text-[#97978f]">
                Typ hier je bericht…
              </div>
            </div>
