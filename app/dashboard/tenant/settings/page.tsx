                ...
                <div className="pb-4 space-y-3">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#163300]/20"
                    />
                  </div>
                  <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-[#163300] hover:bg-[#163300]/90 rounded-lg transition-colors disabled:opacity-50"
                    >
                ...
                <div className="pb-4 space-y-3">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      pwResetCooldown > 0 ? 'bg-gray-300 dark:bg-neutral-600 cursor-not-allowed' : 'bg-[#163300] hover:bg-[#163300]/90'
                    )}
                  >
                          ...
                          <div className="mt-2 pt-4 border-t border-gray-200 dark:border-neutral-700 space-y-4">
                            ...
                            <div className="space-y-1.5">
                              ...
                              <input
                                ...
                                className="w-36 rounded-lg border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2 text-sm text-center tracking-widest font-mono focus:outline-none focus:ring-2 focus:ring-[#163300]/20"
                              />
                            </div>
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className="px-4 py-2 text-sm font-medium text-white bg-[#163300] hover:bg-[#163300]/90 rounded-lg transition-colors disabled:opacity-50"
                              >
