  ...
  const renderActions = (d: DocumentRow, layout: 'inline' | 'stack' = 'inline') => (
    <div className={cn('flex gap-2', layout === 'stack' ? 'flex-col w-full mt-3' : 'justify-end flex-wrap')}>
      ...
      <Button
        type="button"
        size="sm"
        className={cn('rounded-full bg-[#9FE870] text-[#163300] hover:bg-[#8AD45F]', layout === 'stack' && 'w-full justify-center')}
        disabled={!d.storage_path && !isDemo}
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-lg font-semibold text-[#163300] dark:text-[#9FE870]">Documenten</p>
