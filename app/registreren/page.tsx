  ...
  return (
    <AuthPageShell>
            ...
            <>
              ...
              {step === 1 && (
                <p className="mt-2 text-sm text-gray-600">
                  ...
                  <Link
                    href="/login"
                    className="font-medium text-[#1d3014] underline underline-offset-2 hover:no-underline"
                  >
                    Inloggen
                  </Link>
                </p>
          ...
          <p className="mt-8 text-center text-xs text-gray-500 leading-relaxed">
            ...
            <Link href="/algemene-voorwaarden" className="font-medium text-[#1d3014] underline underline-offset-2">
              Algemene voorwaarden
            </Link>{' '}
            en{' '}
            <Link href="/privacy" className="font-medium text-[#1d3014] underline underline-offset-2">
              Privacybeleid
            </Link>
            .
          </p>
