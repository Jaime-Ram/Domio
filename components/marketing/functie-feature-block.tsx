  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center">
        <h3 className="text-2xl sm:text-3xl font-bold text-[#1d3014] tracking-tight">
          {title}
        </h3>
        ...
        <Link
          href={demoHref}
          className="mt-6 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#c8e957] text-[#1d3014] font-semibold text-base hover:bg-[#c8e957]/90 transition-colors w-fit"
        >
          Bekijk in demo
...
export function InkomstenWidget() {
  return (
    <div className="rounded-[1.75rem] bg-[#1d3014] p-6 sm:p-8 shadow-xl border border-[#1d3014]/20">
  ...
  return (
    <div className="rounded-[1.75rem] bg-white dark:bg-neutral-900 p-6 sm:p-8 shadow-xl border border-gray-200/80 dark:border-neutral-700">
      <div className="flex items-center gap-3 mb-6">
        <div className="h-12 w-12 rounded-full bg-[#1d3014] flex items-center justify-center">
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center py-3">
          ...
          <span className="font-semibold text-[#1d3014]">83%</span>
        </div>
      </div>
    </div>
  )
    ...
    <div className="rounded-[1.75rem] bg-white dark:bg-neutral-900 p-6 sm:p-8 shadow-xl border border-gray-200/80 dark:border-neutral-700">
      ...
      <div className="flex items-center gap-4">
        <div className="flex-1 rounded-2xl bg-gray-100 dark:bg-neutral-800 p-4">
          <p className="text-3xl font-bold text-[#1d3014]">142</p>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Punten</p>
        </div>
        <div className="flex-1 rounded-2xl bg-[#c8e957]/20 dark:bg-[#c8e957]/10 p-4">
          <p className="text-lg font-semibold text-[#1d3014]">Label B</p>
    ...
    <div className="rounded-[1.75rem] bg-gradient-to-br from-gray-100 to-gray-200 dark:from-neutral-800 dark:to-neutral-900 aspect-[4/3] sm:aspect-video flex items-center justify-center border border-gray-200/80 dark:border-neutral-700 shadow-xl overflow-hidden">
      <div className="text-center p-8">
        <div className="w-24 h-24 mx-auto mb-4 rounded-2xl bg-white/80 dark:bg-neutral-800 flex items-center justify-center">
          <Building2 className="h-12 w-12 text-[#1d3014]" />
        </div>
