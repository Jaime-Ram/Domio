        ...
        <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              ...
              <div className="@container relative min-h-[120px] w-full grow max-lg:mx-auto max-lg:max-w-sm">
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              ...
              <div className="@container flex flex-1 items-center justify-center gap-2 max-lg:py-6 lg:pb-2">
                <div className="flex h-[min(152px,40cqw)] w-full items-center justify-center gap-2">
                  <Avatar className="h-10 w-10 border-2 border-white">
                    <AvatarFallback className="bg-[#002A1F] text-white text-sm">JD</AvatarFallback>
                  </Avatar>
                  <Avatar className="h-10 w-10 border-2 border-white -ml-2">
                    <AvatarFallback className="bg-[#356258] text-white text-sm">MS</AvatarFallback>
                  </Avatar>
                  <Avatar className="h-10 w-10 border-2 border-white -ml-2">
                    <AvatarFallback className="bg-[#002A1F] text-white text-sm">PV</AvatarFallback>
                  </Avatar>
                  <Avatar className="h-10 w-10 border-2 border-white -ml-2">
                    <AvatarFallback className="bg-[#356258] text-white text-sm">AK</AvatarFallback>
                  </Avatar>
                  <Avatar className="h-10 w-10 border-2 border-white -ml-2">
                    <AvatarFallback className="bg-[#002A1F] text-white text-sm">LW</AvatarFallback>
                  </Avatar>
                </div>
              </div>
            </div>
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              ...
              <div className="relative min-h-[120px] w-full grow">
