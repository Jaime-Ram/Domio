      ...
      <div className="container mx-auto w-full max-w-7xl px-4">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12">
          {featureCategories.map((category, categoryIndex) => (
            <div
              key={categoryIndex}
              className="rounded-xl bg-gradient-to-br from-[#1d3014]/5 to-[#356258]/5 p-6 dark:from-[#1d3014]/10 dark:to-[#356258]/10"
            >
              <h3 className="mb-6 text-xl font-bold text-[#1d3014] dark:text-[#c8e957]">
                {category.title}
              </h3>
              <ul className="space-y-4">
                {category.features.map((feature, featureIndex) => {
                  ...
                  return (
                    ...
                    >
                      <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#1d3014]/10 dark:bg-[#c8e957]/20">
                        <Icon className="h-3.5 w-3.5 text-[#1d3014] dark:text-[#c8e957]" />
                      </div>
