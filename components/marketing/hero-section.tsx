...
export function HeroSection({ onSignupClick }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-visible pt-0 pb-0 md:pt-0 md:pb-0">
      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-4xl lg:px-8 relative z-10 pt-24 pb-12 md:pt-28 md:pb-16">
        ...
        <div className="flex flex-row items-center gap-3 justify-center pb-[25vh]">
          {/* Gratis aanmelden button - visible on all screen sizes */}
          <Button
