      ...
      >
        ...
        {headerLeft || subtitle ? (
          <div className="px-6 pt-6 pb-5 border-b border-gray-100 dark:border-neutral-800 pr-14 shrink-0 flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <DialogPrimitive.Title className="text-xl font-bold text-[#1d3014] dark:text-[#c8e957] leading-tight truncate">
                {title}
        ...
        {footer !== undefined ? footer : (
          <div className="border-t border-gray-100 dark:border-neutral-800 p-4 flex items-center justify-end gap-3 shrink-0">
            ...
            <button
              type="button"
              className="inline-flex items-center justify-center rounded-full bg-[#c8e957] hover:bg-[#8AD45F] text-[#1d3014] text-sm font-semibold px-5 py-2 transition-colors"
            >
              Opslaan
            </button>
          </div>
