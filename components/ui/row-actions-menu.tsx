    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          aria-label={label}
          className="h-8 w-8 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#c8e957]/40"
        >
